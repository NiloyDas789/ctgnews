      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-4 site-logo">
            <a href="index.html" class="text-black h2 mb-0">Directory</a>
          </div>
    ...
    <div class="row ">
          <div class="col-sm-3 col-6">
            ...
            <div class="card p-3 mt-2 mb-2">
              <!-- Content -->
              <div class="entry2">
              <a href="single.html"><img src="{{asset('directory')}}/images/img_1.jpg" alt="Image" class="img-fluid rounded"></a>
              <div class="excerpt">
              

              <h4><a href="single.html">The AI magically removes moving objects from videos.</a></h4>
...
<div>
  ...
  <script src="{{asset('directory')}}/js/popper.min.js"></script>
  <script src="{{asset('directory')}}/js/bootstrap.min.js"></script>
  <script src="{{asset('directory')}}/js/owl.carousel.min.js"></script>
  <script src="{{asset('directory')}}/js/jquery.stellar.min.js"></script>
  <script src="{{asset('directory')}}/js/jquery.countdown.min.js"></script>
  <script src="{{asset('directory')}}/js/jquery.magnific-popup.min.js"></script>
  <script src="{{asset('directory')}}/js/bootstrap-datepicker.min.js"></script>
